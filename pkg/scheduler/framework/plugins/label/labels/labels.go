...
// GaiaLabels allows you to present labels independently from their storage.
type GaiaLabels interface {
...
// Set is a map of label:value. It implements GaiaLabels.
...
func (ls Set) String() string {
	...
	for key, value := range ls {
		selector = append(selector, key+"="+strings.Join(value, ","))
	}
