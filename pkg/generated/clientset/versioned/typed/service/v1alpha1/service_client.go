...
// ServiceV1alpha1Client is used to interact with features provided by the service.gaia.io group.
type ServiceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServiceV1alpha1Client) HyperLabels(namespace string) HyperLabelInterface {
	return newHyperLabels(c, namespace)
}
...
// NewForConfigAndClient creates a new ServiceV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ServiceV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := servicev1alpha1.SchemeGroupVersion
