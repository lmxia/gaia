...
var managedclustersResource = schema.GroupVersionResource{Group: "platform.gaia.io", Version: "v1alpha1", Resource: "managedclusters"}

var managedclustersKind = schema.GroupVersionKind{Group: "platform.gaia.io", Version: "v1alpha1", Kind: "ManagedCluster"}
...
func (c *FakeManagedClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagedCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(managedclustersResource, c.ns, name), &v1alpha1.ManagedCluster{})
...
func (c *FakeManagedClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagedClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(managedclustersResource, managedclustersKind, c.ns, opts), &v1alpha1.ManagedClusterList{})
...
func (c *FakeManagedClusters) Create(ctx context.Context, managedCluster *v1alpha1.ManagedCluster, opts v1.CreateOptions) (result *v1alpha1.ManagedCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(managedclustersResource, c.ns, managedCluster), &v1alpha1.ManagedCluster{})
...
func (c *FakeManagedClusters) Update(ctx context.Context, managedCluster *v1alpha1.ManagedCluster, opts v1.UpdateOptions) (result *v1alpha1.ManagedCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(managedclustersResource, c.ns, managedCluster), &v1alpha1.ManagedCluster{})
...
func (c *FakeManagedClusters) UpdateStatus(ctx context.Context, managedCluster *v1alpha1.ManagedCluster, opts v1.UpdateOptions) (*v1alpha1.ManagedCluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(managedclustersResource, "status", c.ns, managedCluster), &v1alpha1.ManagedCluster{})
...
func (c *FakeManagedClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(managedclustersResource, c.ns, name, opts), &v1alpha1.ManagedCluster{})
...
func (c *FakeManagedClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagedCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(managedclustersResource, c.ns, name, pt, data, subresources...), &v1alpha1.ManagedCluster{})
