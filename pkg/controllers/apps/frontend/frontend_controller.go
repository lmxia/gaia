...
func NewController(gaiaClient gaiaClientSet.Interface, gaiaInformerFactory gaiaInformers.SharedInformerFactory,
	vhostClient vhostClient.Interface, aliyunSourceSite string,
) (*Controller, error) {
	...
	c := &Controller{
		workqueue: workqueue.NewTypedRateLimitingQueueWithConfig(
			...
			workqueue.TypedRateLimitingQueueConfig[string]{Name: "Frontend"},
		),
...
func (c *Controller) processNextWorkItem() bool {
	...
	err := func(obj string) error {
		...
		klog.Infof("successfully synced frontend accelerate %q", obj)
		return nil
	}(obj)
	if err != nil {
