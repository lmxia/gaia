...
// ClusterV1alpha1Client is used to interact with features provided by the cluster.pml.com.cn group.
type ClusterV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ClusterV1alpha1Client) Hypernodes(namespace string) HypernodeInterface {
	return newHypernodes(c, namespace)
}
