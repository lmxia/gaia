...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedClusterOptions) DeepCopyInto(out *ManagedClusterOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedClusterOptions.
func (in *ManagedClusterOptions) DeepCopy() *ManagedClusterOptions {
	if in == nil {
		return nil
	}
	out := new(ManagedClusterOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManagedClusterStatus) DeepCopyInto(out *ManagedClusterStatus) {
	*out = *in
	...
	if in.NodesResources != nil {
		in, out := &in.NodesResources, &out.NodesResources
...
func (in *NodeResources) DeepCopyInto(out *NodeResources) {
	*out = *in
	...
	if in.CapacityGPU != nil {
		in, out := &in.CapacityGPU, &out.CapacityGPU
		*out = make(map[string]int, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.AvailableGPU != nil {
		in, out := &in.AvailableGPU, &out.AvailableGPU
		*out = make(map[string]int, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *TargetSpec) DeepCopyInto(out *TargetSpec) {
	*out = *in
	if in.ReportFrequency != nil {
		in, out := &in.ReportFrequency, &out.ReportFrequency
		*out = new(int64)
		**out = **in
	}
	if in.CollectFrequency != nil {
		in, out := &in.CollectFrequency, &out.CollectFrequency
		*out = new(int64)
		**out = **in
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Topo) DeepCopyInto(out *Topo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Topo.
func (in *Topo) DeepCopy() *Topo {
	if in == nil {
		return nil
	}
	out := new(Topo)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Topos) DeepCopyInto(out *Topos) {
	*out = *in
	if in.Topo != nil {
		in, out := &in.Topo, &out.Topo
		*out = make([]Topo, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Topos.
func (in *Topos) DeepCopy() *Topos {
	if in == nil {
		return nil
	}
	out := new(Topos)
