...
type fakeDescriptions struct {
	*gentype.FakeClientWithList[*v1alpha1.Description, *v1alpha1.DescriptionList]
	Fake *FakeAppsV1alpha1
}

func newFakeDescriptions(fake *FakeAppsV1alpha1, namespace string) appsv1alpha1.DescriptionInterface {
	return &fakeDescriptions{
		gentype.NewFakeClientWithList[*v1alpha1.Description, *v1alpha1.DescriptionList](
			fake.Fake,
			namespace,
